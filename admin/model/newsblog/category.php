...
class ModelNewsBlogCategory extends Model {
	public function addCategory($data,$settings) {
		...
		if (isset($data['keyword'])) {
			$this->db->query("INSERT INTO " . DB_PREFIX . "seo_url SET query = 'newsblog_category_id=" . (int)$category_id . "', keyword = '" . $this->db->escape($data['keyword']) . "'");
		}
	...
	public function editCategory($category_id, $data, $settings) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "seo_url WHERE query = 'newsblog_category_id=" . (int)$category_id . "'");
	...
	public function getCategory($category_id) {
		...
		(SELECT DISTINCT keyword FROM " . DB_PREFIX . "seo_url WHERE query = 'newsblog_category_id=" . (int)$category_id . "') AS keyword
