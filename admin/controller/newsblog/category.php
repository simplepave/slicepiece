...
class ControllerNewsBlogCategory extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	public function repair() {
		...
		if ($this->validateRepair()) {
			...
			$this->response->redirect($this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('newsblog/category/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('newsblog/category/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['repair'] = $this->url->link('newsblog/category/repair', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'edit'        		=> $this->url->link('newsblog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true),
				'delete'      		=> $this->url->link('newsblog/category/delete', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $result['category_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . '&sort=sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('newsblog/category_list', $data));
	}
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['category_id'])) {
			$data['action'] = $this->url->link('newsblog/category/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('newsblog/category/edit', 'user_token=' . $this->session->data['user_token'] . '&category_id=' . $this->request->get['category_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('newsblog/category', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('newsblog/category_form', $data));
	}
