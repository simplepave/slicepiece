...
class ControllerNewsBlogArticle extends Controller {
	...
	public function index() {
		if (empty($this->session->data['check_version_newsblog']))
			$this->session->data['check_version_newsblog'] = $this->version_newsblog;
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL'));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL')
		);

		$data['add'] = $this->url->link('newsblog/article/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['copy'] = $this->url->link('newsblog/article/copy', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		$data['delete'] = $this->url->link('newsblog/article/delete', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		foreach ($results as $result) {
			...
			$data['articles'][] = array(
				...
				'edit'       		=> $this->url->link('newsblog/article/edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $result['article_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=pd.name' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=p.status' . $url, 'SSL');
		$data['sort_date_available'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=p.date_available' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=p.date_modified' . $url, 'SSL');
		$data['sort_order'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . '&sort=p.sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', 'SSL');
		...
		$this->response->setOutput($this->load->view('newsblog/article_list', $data));
	}
    ...
    if ($this->config->get('config_editor_default')) {
		...
		if (!isset($this->request->get['article_id'])) {
			$data['action'] = $this->url->link('newsblog/article/add', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		} else {
			$data['action'] = $this->url->link('newsblog/article/edit', 'user_token=' . $this->session->data['user_token'] . '&article_id=' . $this->request->get['article_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('newsblog/article', 'user_token=' . $this->session->data['user_token'] . $url, 'SSL');
		...
		$this->response->setOutput($this->load->view('newsblog/article_form', $data));
	}
