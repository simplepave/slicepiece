...
class ControllerNewsBlogCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
            ...
            $articles_image_size = [600, 400];
            $category_image_size = [600, 400];
    		...
    		if ($category_info['settings']) {
                ...
                $articles_image_size = [
                    (int)$settings['images_size_width']?: 600,
                    (int)$settings['images_size_height']?: 400,
                ];

                $category_image_size = [
                    (int)$settings['image_size_width']?: 600,
                    (int)$settings['image_size_height']?: 400,
                ];
			...
			if ($category_info['image']) {
				$data['original']	= $scheme . 'image/'.$category_info['image'];
			...
			foreach ($categories as $category) {
				if ($category['image']) {
					$original 	= $scheme . 'image/'.$category['image'];
