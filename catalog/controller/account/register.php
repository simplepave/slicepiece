...
class ControllerAccountRegister extends Controller {
    ...
    public function index()
    {
        ...
        elseif ($this->request->server['REQUEST_METHOD'] == 'POST' && $this->request->post['action'] == 'register') {
            ...
            $sp_valid->validation([
                ...
                'confirm'  => 'bail|required|confirmed:password,Пароль',
            ]);

            if ($this->model_account_customer->getTotalCustomersByEmail($this->request->post['email']))
                $email_exists = 'E-Mail уже зарегистрирован!';

            if ($sp_valid->status && empty($email_exists)) {
                ...
                $json = [
                    'status'   => 'success',
                    'message'  => 'Ваша учетная запись создана!',
                    'redirect' => $this->url->link('account/account', '', true),
                ];
            }
            else {
                ...
                if (isset($email_exists))
                    $json['message']['email']['exists'] = $email_exists;
            }
        }
